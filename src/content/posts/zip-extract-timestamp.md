...
draft: false
description: "Windows標準や一部の解凍アプリで圧縮ファイルを展開すると、ファイルの更新日時が変わることがあります。対応している解凍ソフトを使う方法と、プロパティでブロック解除してから展開する方法をまとめました。"
image: "/images/zip-extract-timestamp/cover.png"
tags: ["Windows", "ZIP", "7-Zip", "ファイル管理", "個人メモ"]
