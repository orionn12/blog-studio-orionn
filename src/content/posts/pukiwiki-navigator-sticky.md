...
draft: false
description: "長いPukiWikiページの編集で、毎回上部の編集ボタンまでスクロールで戻るのが面倒でした。中身に詳しくなくても、AIに頼んでスキンのファイルを1か所変えてもらうだけで、ナビゲーションバーが画面上端に追従するように。AIで実現した小さな改善の話です。"
image: "/images/pukiwiki-navigator-sticky/cover.png"
tags: ["PukiWiki", "CSS", "AI開発", "Claude", "個人開発"]
