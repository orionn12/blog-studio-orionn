...
draft: false
description: "身内のトリミングサロンのHPを、WordPressから Astro + Firebase Hosting の静的サイトにリニューアルした記録。方針転換の理由、デザインAIからClaudeへの切り替え、お知らせをGoogleスプレッドシートで更新できるようにした工夫まで紹介します。"
image: "/images/trimming-salon-astro-firebase/cover.png"
tags: ["Astro", "Firebase", "Claude", "AI", "個人開発"]
...
![わんにゃんサロンMOON Webサイト](/images/trimming-salon-astro-firebase/cover.png)
