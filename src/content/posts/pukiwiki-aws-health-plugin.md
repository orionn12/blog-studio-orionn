...
draft: false
description: "PukiWikiでAWS Healthのイベントを管理していたら数が増えて大変に。そこで、データをWikiページに埋め込んで表示・編集できるプラグインを自作したら、追加も削除もボタン1つになり、管理がぐっと楽になった話。"
image: "/images/pukiwiki-aws-health-plugin/screen.png"
tags: ["PukiWiki", "PHP", "JavaScript", "AWS", "個人開発"]
...
![データの流れ](/images/pukiwiki-aws-health-plugin/flow.png)
